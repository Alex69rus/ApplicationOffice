...
#nullable disable
    ...
    public class ExternalController : Controller
    {
        ...
        private readonly SignInManager<AoIdentityUser> _signInManager;
        ...
        public ExternalController(
            ...
            SignInManager<AoIdentityUser> signInManager,
        ...
        private async Task<(AoIdentityUser user, string provider, string providerUserId, IEnumerable<Claim> claims)>
        ...
        private async Task<AoIdentityUser> AutoProvisionUserAsync(string provider, string providerUserId, IEnumerable<Claim> claims)
        {
